...
- **🏠 Ausrichter-Rotation für den 1. Durchgang**: Neu in der Liga-Einteilung – pro Liga wird vorgeschlagen, welcher Verein den 1. Durchgang ausrichtet. Der Vorschlag rotiert fair über die Jahre: Wer zuletzt (oder noch nie) ausgerichtet hat, steht oben; wer letztes Jahr dran war, rückt nach hinten. So trifft es nicht jedes Jahr dieselben Vereine. Die Auswahl ist pro Liga über ein Dropdown änderbar; mit „Ausrichter speichern" wird die diesjährige Einteilung für die Rotation festgehalten (getrennt je Liga, Luftdruck und Kleinkaliber unabhängig)
- **🎯 Vereins-Standkapazität (wer kann was ausrichten)**: In der Vereinsverwaltung lässt sich jetzt pro Verein hinterlegen, welche Wettkämpfe er an eigenen Ständen ausrichten kann (Luftdruck / KK-Gewehr / KK-Pistole). Vereine ohne passenden Stand werden beim Ausrichter-Vorschlag nicht vorgeschlagen – wichtig z. B. für KK-Pistole (25m-Stand). Fehlt die Angabe noch, erinnert ein Hinweis nach dem Login (für Admin/KV-Orga) ans Nachpflegen
- **🐛 E-Mail-Verteiler: Empfänger gingen verloren**: Wichtiger Fix — beim Versand an mehrere Gruppen (z. B. „Meine Liste" + „Sportleiter" + „Mannschaftsführer") kamen viel zu wenige Empfänger an, weil Kontakte, die mehreren Gruppen angehören (z. B. ein Sportleiter, der auch in „Meiner Liste" steht), nur der ersten Rolle zugeordnet und aus den anderen Gruppen herausgefiltert wurden. Jetzt zählt ein Kontakt in ALLE Gruppen, denen er angehört – der Verteiler erreicht wieder alle ausgewählten Personen. Zusätzlich: Doppel-Adressen werden unabhängig von Groß-/Kleinschreibung erkannt und der Versand hält zwischen den Sende-Blöcken eine kurze Pause ein (schützt vor dem Rate-Limit bei großen Verteilern)
- **🐛 Gesamtliste-Excel: Rang-Berechnung korrigiert**: In der Excel-Gesamtliste stand beim Rang „#NAME?" (die verwendete RANG-Funktion vertrug die verstreuten Zellbezüge nicht). Der Rang wird jetzt über eine sprach- und versionsunabhängige Vergleichsformel berechnet – Einzel- und Mannschaftsrang rechnen sich damit korrekt und aktualisieren sich weiterhin automatisch beim Eintragen der Ringe
- **📊 Gesamtliste-Generator: alle Saisons wählbar**: Im Gesamtergebnisliste-Generator ließ sich keine Saison auswählen, wenn gerade keine Saison auf „Laufend" stand. Jetzt werden alle Saisons angeboten (auch in Vorbereitung oder abgeschlossen), nach Jahr sortiert; die Liga-Auswahl richtet sich automatisch nach der gewählten Saison (und damit nach Disziplin Luftdruck/Kleinkaliber)

---

## Version 3.0.4
- **📋 Liga-Einteilung als Text kopieren**: Neuer Button „Als Text kopieren" in der Liga-Einteilung. Er erzeugt eine übersichtliche Auflistung (Liga → Mannschaft → Schützen, Einzelmeldungen gekennzeichnet) und legt sie in die Zwischenablage – ideal zum Verschicken an die Sportleiter zur Kontrolle. Ist die Zwischenablage nicht verfügbar, wird stattdessen eine Textdatei heruntergeladen
- **🔢 Liga-Einteilung: Meldungsübersicht & keine starre 6er-Warnung**: Oben in der Liga-Einteilung steht jetzt eine Gesamtaufzählung der Meldungen je Disziplin (z. B. „LGA: 21 Mannschaften + 3 Einzel, LGS: 4 … , LP: 3 …"). Die Ligen zeigen nur noch die tatsächliche Anzahl – das starre „x / 6" samt Warnzeichen wurde entfernt, da auch ausgeglichene Aufteilungen wie 6/5/5/5 völlig in Ordnung sind
- **👥 Liga-Einteilung: Schützennamen sichtbar & Zugang ohne Analyse**: In der Liga-Einteilung stehen jetzt unter jeder Mannschaft die Schützennamen – so sieht man auf einen Blick, welcher Einzelstarter (z. B. per Nachname) zu welcher Mannschaft passt. Außerdem kommt man über „Aktuelle Einteilung anzeigen" auch ohne vorherige Analyse direkt zur Einteilung (nur Ziel-Saison wählen) und kann dort per Drag & Drop sortieren; die Analyse wird nur noch für den automatischen Auf-/Abstieg und den Ligagrößen-Ausgleich nach Ringzahl benötigt
- **🏅 RWK-Tabellen: Einzelmeldungen außer Wertung**: Einzelmeldungen (Mannschaften mit weniger als 3 Schützen) erscheinen in der Mannschaftstabelle jetzt als „Einzel" gekennzeichnet, bekommen aber keinen Platz und werden nicht in die Mannschaftsplatzierung eingerechnet (analog zu „außer Konkurrenz"). Sie verfälschen dadurch auch nicht mehr die Wertung der echten Mannschaften. In der Einzelrangliste tauchen die Schützen wie gewohnt auf
- **🔒 Liga-Einteilung: Disziplin bleibt immer erhalten**: Beim manuellen Verschieben (Drag & Drop / Dropdown) und beim automatischen Ausgleich wird die Disziplin einer Mannschaft (LGA / LGS / LP) jetzt nie mehr verändert. Der Versuch, eine Auflage-Mannschaft in eine Pistolen-Liga (oder umgekehrt) zu ziehen, wird mit einem Hinweis abgelehnt, statt die Disziplin umzuschreiben. So kann nicht mehr versehentlich aus einer LGA- eine LP-Mannschaft werden
- **📊 Mannschaftsverwaltung: Disziplin-Übersicht**: In der Admin-Mannschaftsverwaltung wird jetzt gezählt, wie viele Mannschaften (und Einzel) je Disziplin gemeldet sind (LGA / LGS / LP bzw. KKG / KKP) – praktisch zum Prüfen der Meldungen
- **🛡️ Auf-/Abstieg: keine Disziplin-Verwechslung mehr**: Wichtiger Fix — der Auf-/Abstieg konnte bei gleichnamigen Mannschaften (z. B. „SGi Einbeck I" gibt es in Auflage UND Luftpistole) versehentlich die falsche Mannschaft erwischen und dabei ihre Disziplin umstellen (aus einer Luftpistolen- wurde eine Auflage-Mannschaft). Der unsichere reine Namensabgleich wurde entfernt; Mannschaften werden jetzt ausschließlich innerhalb derselben Disziplin zugeordnet und niemals über Disziplingrenzen hinweg verschoben
- **🏷️ Auf-/Abstieg: Disziplin-Kennzeichen in der Einteilung**: In der Liga-Einteilung steht jetzt hinter jeder Mannschaft die Disziplin (LGA / LGS / LP) als Kennzeichen – hilfreich beim Sortieren und Einordnen, besonders bei den „Nicht zugewiesen"-Mannschaften
