...
## Version 3.0.2
- **🔼🔽 Auf-/Abstieg jetzt anwendbar**: Bestätigte Auf-/Abstiegs-Vorschläge sortieren die tatsächlich gemeldeten Mannschaften der neuen Saison in die richtige Liga ein (vorher nur Vorschau). Es werden ausschließlich bereits gemeldete Mannschaften umsortiert – es wird nichts hinzugefügt oder überschrieben; im Vorjahr vorhandene, aber nicht mehr gemeldete Mannschaften werden übersprungen (und in der Rückmeldung ausgewiesen). Auswahl der Ziel-Saison im Auf-/Abstiegs-Bereich; die Quell-Saison bleibt unverändert. Zuordnung über Rückverweis auf die Vorsaison-Mannschaft bzw. – falls nicht vorhanden – über den Mannschaftsnamen, jeweils über den Liga-Rang und innerhalb derselben Disziplin. Korrektur: Luftgewehr-Auflage-Ligen (Kreisoberliga/Kreisliga/Kreisklassen) haben wieder Auf-/Abstieg; nur echte offene Klassen (LG Freihand, Luftpistole, KK-Sportpistole) bleiben ausgenommen
