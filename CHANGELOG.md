...
## Version 3.0.2
- **🔼🔽 Auf-/Abstieg jetzt anwendbar**: Bestätigte Auf-/Abstiegs-Vorschläge verschieben die Mannschaften jetzt tatsächlich in die richtige Liga der neuen Saison (vorher nur Vorschau). Auswahl der Ziel-Saison im Auf-/Abstiegs-Bereich; die Quell-Saison bleibt unverändert. Die Zuordnung erfolgt über einen Rückverweis auf die Vorsaison-Mannschaft und den Liga-Rang – Auf-/Abstieg bleibt dabei innerhalb derselben Disziplin. Korrektur: Luftgewehr-Auflage-Ligen (Kreisoberliga/Kreisliga/Kreisklassen) haben wieder Auf-/Abstieg; nur echte offene Klassen (LG Freihand, Luftpistole, KK-Sportpistole) bleiben ausgenommen
