...
**Aktuell: Version 2.6.0** – Mitcom-Import: Vereine können Mitgliederdaten aus der Mitcom-Excel importieren (Geschlecht, Geburtsjahr, Mitgliedsnummer).
...
*Letzte Aktualisierung: heute - Version 2.6.0*
