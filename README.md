...
**Version: 3.0.5** | **Android: 1.0.0** | **20.09.2026**
...
[![Version](https://img.shields.io/badge/Version-3.0.5-green?style=for-the-badge)](#)
...
**Aktuell: Version 3.0.5 (20.09.2026)** – Faire Ausrichter-Rotation für den 1. Durchgang (mit Vereins-Standkapazität LG/KK-Gewehr/KK-Pistole), wichtige Korrektur am E-Mail-Verteiler (alle ausgewählten Empfänger werden wieder erreicht) und Fix der Rang-Berechnung in der Excel-Gesamtliste. Baut auf 3.0.4 auf (Auf-/Abstieg mit Ligagrößen-Ausgleich, Gesamtliste als Excel/PDF, Abgabetermin-Hinweis).
...
*Letzte Aktualisierung: 20.09.2026 - Version 3.0.5*
