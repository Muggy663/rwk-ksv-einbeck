export const features = {
  ...
  'Komplette Vereinssoftware': [
    'Digitale Mitgliederverwaltung, zentral und sicher.',
    'Automatisierte Beitragsverwaltung mit SEPA-Export.',
    'Jubiläen, Ehrungen und Lizenzen immer im Blick.',
  ],
  'Moderne Technologie': [
