...
function LegacyAdminResultsPage() {
  const { user } = useAuth();
                  ...
                  {handzettelFiles.length > 0 && attachOnly && (
                    <div className="mt-3 p-3 bg-green-100 rounded border border-green-200 w-full max-w-full overflow-hidden">
                      ...
                      <p className="text-xs text-green-700 dark:text-green-300 mt-2">
                        💡 Handzettel werden ohne automatisches Auslesen per E-Mail an RWK-Leiter gesendet
                      </p>
                    </div>
                  )}
      ...
      <Card className="shadow-md">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <Button onClick={handleAddToList} disabled={!selectedShooterId || !selectedRound || !score || isSubmittingScores || isLoadingExistingScores} className="w-full md:w-auto">
          ...
          <CardContent>
            ...
            <div className="block md:hidden space-y-4">
              {pendingScores.map((entry) => {
                ...
                return (
                  <Card key={entry.tempId} className={`p-4 ${rowColor}`}>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className={`font-medium ${textColor}`}>{entry.shooterName}</h3>
                        </div>
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        {entry.isOCRGenerated && entry.ocrConfidence && (
                          <div className="text-xs">
                            <span className="font-medium">Computer-Sicherheit:</span> 
              ...
              <div className="mb-4 p-3 bg-amber-50 border-l-4 border-amber-400">
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-amber-700">
                    ...
                    Einträge wurden automatisch vom Computer erkannt. Bitte prüfen Sie alle Werte vor dem Speichern!
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="flex justify-end pt-6">
              <Button onClick={handleFinalSave} size="lg" disabled={isSubmittingScores || pendingScores.length === 0} className="w-full md:w-auto">
