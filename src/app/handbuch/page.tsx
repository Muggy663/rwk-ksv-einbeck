      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <div>
          ...
          <p className="text-lg text-muted-foreground">
            Funktionen und Bedienung der Rundenwettkampf (RWK) und Kreismeisterschafts (KM) App. (Stand: 02.09.2025, Web-Version 0.11.9, App-Version 0.9.4.1, KM-System 1.0.0)
          </p>
        </div>
      </div>
