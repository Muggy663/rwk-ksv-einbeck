      ...
      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-3 mb-4 md:mb-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-xs md:text-sm text-muted-foreground mt-1">
            Stand: Version 3.0.7 - Next.js 16 + Glassmorphism Design
          </p>
        </div>
      </div>
        ...
        <>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Anleitung zur Nutzung des Kreismeisterschafts-Moduls - Version 3.0.7</CardDescription>
            </CardHeader>
        ...
        <>
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Das digitale Schießtagebuch für Sportschützen - Version 3.0.7</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-sm">
              <ul className="list-disc list-inside pl-4 space-y-1">
