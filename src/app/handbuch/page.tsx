      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <div>
          ...
          <p className="text-lg text-muted-foreground">
            Funktionen und Bedienung der Rundenwettkampf (RWK) und Kreismeisterschafts (KM) App. (Stand: 31.08.2025, Web-Version 0.11.4, App-Version 0.9.1.0, KM-System 1.0.0)
          </p>
        </div>
      </div>
