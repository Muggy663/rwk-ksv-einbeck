...
interface ShooterData {
  name: string;
  seasons: {
    [seasonId: string]: ShooterSeasonData;
  };
}
...
interface ComparisonData {
  name: string;
  year: number;
  [shooterId: string]: string | number;
}

interface ComparisonChartData {
  seasons: Season[];
  shooters: {
    [shooterId: string]: ShooterData;
  };
...
export function SeasonComparisonChart({ 
  ...
  useEffect(() => {
    const loadComparisonData = async () => {
      ...
      try {
        ...
        const dummyData: ComparisonChartData = {
          seasons: [
  ...
  const toggleShooter = (shooter: Shooter) => {
