...
/**
 * Komponente zur Anzeige einer Trendanalyse für Schützen
 * 
 * @param {Object} props
 * @param {Array} props.shooters - Array mit Schützen-Objekten inkl. Trend-Information
 * @param {string} props.className - Zusätzliche CSS-Klassen
 */
export function TrendAnalysisCard({ shooters = [], className }) {
  ...
  const renderShooterList = (shooterList, emptyMessage) => {
