 ...
 * @param {Object} props.league - Liga-Objekt
 * @param {number} props.numRounds - Anzahl der Durchgänge
 * @param {number} props.competitionYear - Wettkampfjahr
 * @param {'teams'|'shooters'} props.type - Typ des Exports (teams oder shooters)
 * @param {string} [props.className] - Zusätzliche CSS-Klassen
 * @param {boolean} [props.useCache=true] - Cache verwenden
 */
