    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile-specific positioning - kompakter und besser positioniert
          isMobile && "w-[calc(100vw-2rem)] max-w-xs",
          // Desktop positioning
          !isMobile && position === "popper" && "data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1",
          className
        )}
      ...
      >
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            !isMobile && position === "popper" && "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]",
            isMobile && "max-h-[35vh] overflow-y-auto w-full"
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
