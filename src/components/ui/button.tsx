...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "glass-button text-primary-foreground hover:glass-strong bg-primary hover:bg-primary/90",
        destructive:
          "glass-button bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "glass-subtle border border-input hover:glass-medium hover:text-accent-foreground",
        secondary:
          "glass-subtle bg-secondary text-secondary-foreground hover:glass-medium",
